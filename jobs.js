...
function update(){const key=level.value||'jr';link.href='https://www.linkedin.com/jobs/search/?keywords='+encodeURIComponent(terms[key]);link.textContent=`Buscar ${labels[key]} en LinkedIn ↗`;}
